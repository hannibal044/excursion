...
exhibit_dict = {'Граната РГД-13': ['https://disk.yandex.ru/d/NQjiV0B5fvGlCA', 'РГД-33 — советская ручная граната, \
                ...
                'Боевое знамя 17 Краснознаменной Бобруйской стрелковой дивизии': ['https://imgur.com/a/HBY1XFB',
                ...
                'Остов пулемёта Дегтярёва': ['https://wampi.ru/image/RuqP5y8',
                ...
                'Пистолет-пулемёт Шпагина': ['https://wampi.ru/image/RuqPYUr',
